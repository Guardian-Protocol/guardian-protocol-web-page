...
import type { BTreeMap, BTreeSet, Bytes, Compact, Enum, Null, Option, Struct, U8aFixed, Vec, bool, u128, u16, u32, u64 } from '@polkadot/types-codec';
...
export interface PalletGearCall extends Enum {
    ...
    readonly type: 'UploadCode' | 'UploadProgram' | 'CreateProgram' | 'SendMessage' | 'SendReply' | 'ClaimValue' | 'Run' | 'SetExecuteInherent' | 'PayProgramRent' | 'ResumeSessionInit' | 'ResumeSessionPush' | 'ResumeSessionCommit';
}
...
export interface PalletGearEvent extends Enum {
    ...
    readonly type: 'MessageQueued' | 'UserMessageSent' | 'UserMessageRead' | 'MessagesDispatched' | 'MessageWaited' | 'MessageWoken' | 'CodeChanged' | 'ProgramChanged' | 'QueueNotProcessed' | 'ProgramResumeSessionStarted';
}
...
export interface GearCoreErrorsSimpleSimpleExecutionError extends Enum {
    ...
    readonly isUnsupported: boolean;
    readonly type: 'RanOutOfGas' | 'MemoryOverflow' | 'BackendError' | 'UserspacePanic' | 'UnreachableInstruction' | 'Unsupported';
}
...
export interface PalletGearProgramError extends Enum {
    ...
    readonly type: 'DuplicateItem' | 'ProgramNotFound' | 'NotActiveProgram' | 'CannotFindDataForPage' | 'ResumeSessionNotFound' | 'NotSessionOwner' | 'ResumeSessionFailed' | 'ProgramCodeNotFound' | 'DuplicateResumeSession';
}
...
export interface PalletGearBankError extends Enum {
    ...
    readonly type: 'InsufficientBalance' | 'InsufficientGasBalance' | 'InsufficientValueBalance' | 'InsufficientBankBalance' | 'InsufficientDeposit';
}
...
export /** @name PalletGearVoucherInternalVoucherInfo (627) */ interface PalletGearVoucherInternalVoucherInfo extends Struct {
    readonly owner: AccountId32;
    readonly programs: Option<BTreeSet<GearCoreIdsProgramId>>;
    readonly codeUploading: bool;
    readonly expiry: u32;
